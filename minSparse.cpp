...
void solve() {
    ...
    cout << "Minimum value in range [0, 5]: " << query(0, 5, table, logValues) << endl;
    cout << "Minimum value in range [3, 8]: " << query(3, 8, table, logValues) << endl;
    cout << "Minimum value in range [1, 6]: " << query(1, 6, table, logValues) << endl;
}
